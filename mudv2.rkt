...
(define key_objects '((0 "a red statue") ;the key-objects used to un lock the gate is randomised with objects and rooms.
                      (1 "a bronze statue")
                      (2 "a sliver statue")
                      (3 "a gold statue")))
...
;---------------------------------maze functions
(define X 10) ;limit maze size to 10 squares along the x axis.
(define Y 10) ;limits maze size to 10 squares along the y axis.
